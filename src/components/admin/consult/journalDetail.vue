        ...
        <div class="card2 mb-4">
          <div class="card-header">
            <div class="d-flex justify-content-end align-items-center">
              <button class="btn btn-sm btn-primary mx-3" @click.prevent="downloadFile(journalList.hanFile)">
                <i class="fas fa-download"></i> 첨부파일 다운로드
              </button>

              <button type="button" class="btn btn-primary btn-sm me-3" @click="exportToPDF('pdfarea')">PDF다운로드</button>
              <router-link type="button" class="btn btn-primary btn-sm" to="/admin/journalList">
                돌아가기
              </router-link>
            </div>
          </div>
              ...
              <form class="resultsReport mx-auto" id="pdfarea">
                ...
                <div class="userInfo">
                  <div class="mentorInfo">
                    ...
                    <div>
                      ...
                      <input type="text" id="field" name="field" class="text-center" v-model="journalList.mentorArea"
                        disabled />
                    </div>
                    <div>
                      <label for="belong">소속기관</label>
                      <input type="text" id="belong" name="belong" class="text-center" v-model="journalList.mentorGroup"
                        disabled />
                    </div>
                    <div class="d-flex">
                      <div class="d-flex my-auto">
                      ...
                      <input type="text" id="level" name="level" class="text-center" v-model="journalList.mentorRank"
                        disabled />
                    </div>
                  </div>
                  <div class="mentorInfo">
                    ...
                    <div class="founded">
                      ...
                      <div class="radioStyle">
                        <div>
                          <input type="radio" id="spare" name="founded" v-model="journalList.menteeIsStartUp"
                            value="spare" disabled />
                          <label for="spare">예비창업자</label>
                        </div>
                        <div>
                          <input type="radio" id="already" name="founded" v-model="journalList.menteeIsStartUp"
                    ...
                    <div>
                      ...
                      <input type="text" id="item" name="item" class="text-center" v-model="journalList.menteeItem"
                        disabled />
                    </div>
                  </div>
                </div>
                <div class="activity">
                  ...
                  <div class="activityLine2">
                    <div class="me-5">
                      ...
                      <input type="text" id="count" name="count" v-model="journalList.degree" class="text-center"
                        style="width:14rem;" disabled />
                    </div>
                    <div class="ms-2">
                      <label for="day">수행날짜</label>
                      <input type="text" id="day" name="day" v-model="journalList.formatDate" class="text-center"
                        style="width:15rem;" disabled />
                    </div>
                    <div class="teach">
                      <p class="ms-5">지도방법</p>
                      <input type="radio" id="contact" name="teach" v-model="journalList.teachingMethod" value="contact"
                        disabled />
                      <label for="contact">대면</label>

                      <input type="radio" id="uncontact" name="teach" v-model="journalList.teachingMethod"
                        value="uncontact" disabled />
                  ...
                  <div class="activityLine">
                    <div class="me-5">
                      ...
                      <input type="text" id="place" name="place" v-model="journalList.place" class="text-center"
                        style="width:14rem;" disabled />
                    </div>
                    <div class="d-flex ms-2">
                      <div class="d-flex my-auto">
                        <label for="etc" class="me-3">참석자</label>
                      </div>
                      <input type="text" id="etc" name="etc" v-model="journalList.etc" class="text-center"
                        style="width:32rem;" disabled />
                    </div>
                  </div>
                </div>
                <div class="request pe-3">
                  ...
                  <div class="w-100 pe-3">
                    <textarea class="form-control" v-model="journalList.subject" disabled></textarea>
                  </div>
                </div>
                ...
                <div class="mentorResults">
                  ...
                  <div class="opinion pe-3">
                    ...
                    <textarea class="w-100 form-control" v-model="journalList.summary" disabled></textarea>
                  </div>
                  ...
                  <div class="opinion pe-3">
                    ...
                    <textarea class="w-100 form-control" v-model="journalList.result" disabled></textarea>
                  </div>
                  ...
                  <div class="opinion pe-3">
                    ...
                    <textarea class="w-100 form-control" v-model="journalList.benefit" disabled></textarea>
                  </div>
                    ...
                    <div class="imageUploadWrap">
                      ...
                      <label for="image02">
                        <div class="imageUpload">
                          <div class="w-100">
                            <span>+</span>
                            <span>사진파일 업로드<img v-if="journalList.img2" :src="journalList.img2" alt="미리보기"></span>
                          </div>
                        </div>
                      </label>
                    </div>
                  ...
                  <div class="opinion">
                    ...
                    <div class="d-flex flex-column justify-content-center align-items-start">
                      <div class="form-control fileInput mt-1">
                        {{ decodeURIComponent(journalList.hanFileName) }}
                      </div>
                    </div>
                  </div>
                </div>
...
export default {
  ...
  methods: {
    ...
    async downloadFile(fileName) {
      ...
      link.href = url;
      link.setAttribute('download', decodeURIComponent(this.journalList.hanFileName));
    ...
    async getConsultingJournalDetail() {
      try {
        ...
        console.log('this', this.journalList);
