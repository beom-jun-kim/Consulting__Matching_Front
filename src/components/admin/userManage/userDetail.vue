      ...
      <div class="container-fluid px-auto">
                    ...
                    <div class="d-flex flex-wrap mb-3">
                      <div class="form-group me-md-5 mb-3">
                        ...
                        <select v-model="userBoard.role" class="form-control py-2 px-3">
                          <option v-for="(role, index) in  getUserToken().role == 'admin' ? roles : roles2" :key="index"
                            :value="role">
                            {{ role }}
                          </option>
                        </select>
        ...
        <div class="d-flex mt-3">
          <div class="mx-auto">
            ...
            <router-link to="/admin/userList" class="btn btn-secondary me-3">
              취소
            </router-link>
...
export default {
  ...
  data() {
    return {
      ...
      insertAt: "",
      changPass: "",
      roles: ["admin", "common", "g-consultant", "s-consultant", "supervisor", "basic", "buildup", "premium", "student"],
      roles2: ["common", "consultant"],
    };
  },
  methods: {
    getUserToken() {
