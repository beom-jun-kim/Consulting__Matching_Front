        ...
        <div class="sp_container">
            ...
            <form class="resultsReport" id="pdfarea">
                ...
                <div class="mentorResults">
                    ...
                    <div class="evaluateBox">
                        ...
                        <textarea
                            :disabled="getUser().role == 'g-consultant' || getUser().role == 's-consultant' || getUser().role == 'supervisor'"
                            placeholder="일지보고서 평가..." v-model="evaluate"></textarea>
                    </div>
                    <!-- <div class="opinion">
                        <div class="subTitle2">
            ...
            <div class="container submit">
                <div class="d-flex">
                    ...
                    <button type="button" @click="updateJournalData" v-if="getUser().role == 'buildup'">저장</button>
                </div>
                <button type="button" @click="saveJournal" v-if="this.$route.params.id == 0">저장</button>
                <div v-else>
                    <button
                        v-if="getUser().role == 'g-consultant' || getUser().role == 's-consultant' || getUser().role == 'supervisor'"
                        type="button" @click="captureAndConvertToPDF">PDF다운로드</button>
                    <button type="button"
                        v-if="getUser().role == 'g-consultant' || getUser().role == 's-consultant' || getUser().role == 'supervisor'"
    ...
    methods: {
            ...
            if (confirm("저장하시겠습니까?")) {
                if (!this.menteeIsStartUp) {
                    ...
                    try {
                        ...
                        formData.append("evaluate", this.evaluate);
        ...
        async getJournalData(id) {
            try {
                ...
                this.evaluate = response.data.evaluate;
                this.appId = parseInt(response.data.appId);
        ...
        async updateJournalData() {
            if (confirm("수정하시겠습니까?")) {
                try {
                    ...
                    formData.append("images", this.$refs.fileInput02.files[0]);
                    formData.append("textFile", this.hanFile);
                    formData.append("appId", parseInt(this.appId));
