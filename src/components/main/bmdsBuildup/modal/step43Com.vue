    ...
    <div>
        ...
        <div class="d-flex justify-content-start" style="height: 5rem">
            <div class="d-flex" style="margin-left: 1rem">
                <div class="d-flex justify-content-between" style="width: 35rem">
        ...
        <div class="modal-wrap">
            <div class="my-3">
                <label for="businessArea" class="preSB form-label" style="font-size: 30px">
                    <span class="primeColor">2.</span> 제품이나 서비스를 고객에게 설명할 수 있는 수준으로 시각적으로 표현해 봅니다.<span
                        style="font-size:17px;">(3D, 플로우 차트 등을 활용해 보세요)</span>
                </label>
            </div>
          ...
          추후 업로드 된 이미지 표시거나 엠바스 링크 필요
            ...
            <div class="d-flex justify-content-center align-items-center mt-4"
                style="height: 36rem; background: #e7e6e6; border-radius: 25px">
                  ...
                  ">
                          ...
                          ">
                            ...
                            "></div>
                                ...
                                <!-- 클릭 영역 -->
                                <img v-if="imgUrl43_1" :src="imgUrl43_1" alt="uploaded image" class="productImg" />
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- <div class="my-3">
            <b-button class="btn btn-sm" style="float: right" @click="saveBuildStep42">저장</b-button>
        </div> -->
    </div>
</template>
  
<script>
import step43 from "./js/step43.js";
export default {
    name: "step43Com",
    ...step43
};
