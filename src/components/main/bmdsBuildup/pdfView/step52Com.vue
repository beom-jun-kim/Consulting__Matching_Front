    ...
    <div style="width: 81rem; height: 41.5rem">
      ...
      >
        <div>
          ...
          <div
            class="step51Img my-3 d-flex flex-column justify-content-between align-items-center"
            id="businessArea"
            style="width: 78rem; height: 37rem"
          >
            <div
              class="preEB d-flex justify-content-center align-items-center mb-3"
            >
              ...
              <div
                type="text"
                class="transparent-input ms-3 d-flex justify-content-center align-items-center"
                style="
                  border-top: none;
                  border-left: none;
                  border-right: none;
                  ...
                  <div @click="handleClick">
                    ...
                    >
                      ...
                      <div
                        v-if="pathUrl52_1"
                        class="productImg"
                        :style="{ backgroundImage: 'url(' + pathUrl52_1 + ')' }"
                        @click.stop
                      ></div>
                    </div>
                  </div>
...
<script>
import step52 from "../modal/js/step52.js";
export default {
  name: "step52Com",
  ...step52,
};
