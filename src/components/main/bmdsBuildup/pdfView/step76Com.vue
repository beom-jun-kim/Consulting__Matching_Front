  ...
  <div>
    ...
    <div>
      <div class="basicContentBar preSB">
        7-3 : 성장을 위한 준비 및 비즈니스 로드맵 계획 수립
      </div>
    </div>
    <div class="preM" style="width: 81rem; height: 41.5rem">
      <div class="my-3">
        <label
          for="businessArea"
        ...
        >
          <span class="primeColor">3.</span> 향후 우리가 성장하기 위해서는 단기,
          중기, 장기적으로 무엇을 할 계획인가요?
        </label>
      </div>
      <div
      ...
      >
        <div>
          <div
            class="step71Img my-3 d-flex flex-column justify-content-end align-items-center"
            id="businessArea"
            style="width: 80rem; height: 34rem"
          >
            <div
              class="d-flex flex-column justify-content-start align-items-center"
              style="width: 100%; height: 25rem; margin-bottom: 2rem"
            >
              <div
                class="d-flex justify-content-between align-items-end"
                style="width: 100%; height: 10rem; margin-top: 4rem"
              >
                <div
                  placeholder="제품/서비스,매출,고용,투자 유치,특허,정부지원사업 참여,인증 등"
                  v-html="goal76_1"
                  style="
                    resize: none;
                    border: none;
              ...
              >
                <div
                  placeholder="전국 매장 50개 확장, 취급상품 30종 이상 확보 등"
                  v-html="activity76_1"
                  style="
                    width: 13rem;
                    height: 4rem;
...
<script>
import step76 from "../modal/js/step76.js";
export default {
  name: "step76Com",
  ...step76,
};
...
.step71Img {
  ...
  position: relative;
  /* overflow: hidden; */
  background-image: url("../../../../assets/buildup/step76.png");
