<template>
  <div>
    ...
    <div>
      <div class="basicContentBar" style="background: #dbeffd">
        <div class="preM basicContent">
          MVP를 설계하여 제작하고 페르소나(persona) 고객을 대상으로 상품성 및
          고객가치 적합성을 평가합니다.
        </div>
      </div>
    </div>
    ...
    <div style="width: 81rem; height: 40rem">
      <div
        class="preM text-center mt-2"
        style="width: 100%; height: 8rem; font-size: 26px; text-align: center"
      >
        "Market-Fit을 위한 MVP 설계 시장 검증 시나리오 설계<br />(데이터 설계,
        설문조사 및 소비자 사용성 평가)<br />검증 데이터 기반 시장 최적화
        제품/서비스 구현"
      </div>
...
.image-container {
  ...
  position: relative;
  overflow: hidden;
  background-image: url("../../../../assets/MVP및고객평가.png");
